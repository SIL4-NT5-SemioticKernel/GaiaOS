...
# Capture SIGTERM and SIGHUP (and you can also capture SIGINT if you prefer)
            ...
            for line in f:
                ...
                try:
                    if mode == "A":
                        ...
                        # Replace the placeholders below with your actual calibration:
...
def read_ultrasonic(trig_pin, echo_pin):
    ...
    # Convert to cm: (duration s × 34300 cm/s) / 2
...
def read_ph(aff):
    ...
    """
    # Lazy-initialize ADS1115 for this I²C address if needed
    ...
    # Convert voltage → pH using calibration constants
    ...
    for aff in afferents:
        try:
            if aff["type"] == "gpio":
                ...
                # Read from /sys/bus/w1/devices/<sensor>/w1_slave
            ...
            # Finally, write the numeric value to the designated file
